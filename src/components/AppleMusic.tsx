...
export default function AppleMusic() {
  ...
  useEffect(() => {
    // Optional: Update isPlaying state if audio ends
  ...
  return (
    <div style={{
      ...
      width: '100%',
      height: '100%',
      backgroundColor: '#1E1E1E', /* Dark UI */
      color: '#FFFFFF',
      ...
      <div style={{
        ...
        {/* Window controls spacer if using native-like titlebars, but MacOsChrome handles it */}
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: '8px 0', display: 'flex', flexDirection: 'column', gap: '4px' }}>
          {["All Playlists", "Favourite Songs", "Alan Walker, Sabr...", "Chatpate songs 🌶️"].map((item) => (
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '20px', overflowX: 'auto', paddingBottom: '20px' }}>
          ...
          <div style={{
            minWidth: '240px',
            height: '280px',
            background: 'linear-gradient(135deg, #1A0A0B 0%, #A90714 100%)',
            borderRadius: '12px',
            padding: '20px',
            position: 'relative',
            ...
            <span style={{ fontSize: '10px', fontWeight: 600, color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase' }}>New Release</span>
            <span style={{ fontSize: '16px', fontWeight: 700 }}>DEVAGAR - EP</span>
            <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.7)' }}>Irokz, OUTL1NE, hexskiii</span>
          </div>
          ...
          <div style={{
            minWidth: '240px',
            height: '280px',
            background: 'linear-gradient(135deg, #FF3D00 0%, #FFB300 100%)',
            borderRadius: '12px',
            padding: '20px',
            position: 'relative',
            boxShadow: '0 10px 30px rgba(0,0,0,0.5)',
            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <h2 style={{ fontSize: '36px', fontWeight: 'bold' }}>Get Up!</h2>
            </div>
            <span style={{ fontSize: '10px', fontWeight: 600, color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase' }}>Made for You</span>
            <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.9)', fontWeight: 500 }}>Yo Yo Honey Singh, Diljit Dosanjh, Elyanna, Stryv...</span>
          </div>
          ...
          <div style={{
            ...
            justifyContent: 'flex-end',
             ...
             <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="100" height="100" viewBox="0 0 100 100" fill="none"><circle cx="50" cy="50" r="40" stroke="white" strokeWidth="4"/><circle cx="50" cy="50" r="25" stroke="white" strokeWidth="4"/></svg>
             </div>
             <span style={{ fontSize: '10px', fontWeight: 600, color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase' }}>Mood for You</span>
             <span style={{ fontSize: '16px', fontWeight: 700 }}>Focus</span>
             <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.9)' }}>Limitless music to help you stay in the zone.</span>
          </div>
        </div>

        <h2 style={{ fontSize: '16px', fontWeight: 600, margin: '20px 0 16px 0', opacity: 0.9 }}>Recently Played</h2>
        <div style={{ display: 'flex', gap: '20px', overflowX: 'auto', paddingBottom: '100px' }}>
          {Array(4).fill(0).map((_, i) => (
             <div key={i} style={{ width: '160px', height: '160px', backgroundColor: '#333', borderRadius: '8px', flexShrink: 0 }}></div>
          ))}
        </div>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 16px', overflow: 'hidden' }}>
            <div style={{ width: '36px', height: '36px', backgroundColor: '#888', borderRadius: '4px', flexShrink: 0, marginRight: '12px' }}>
              <img src="/apple-music-icon.svg" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '4px', filter: 'brightness(0.8)' }} alt="Album Art" />
            </div>
